...
async def format_nation_info(
    ...
    match shard:
        ...
        case "admirables":
            ...
            return [
                discord.Embed(
                    title=f"The people of {nation} are known to be {traits}.", color=color
                )
            ]
        case "animal":
            return [
                discord.Embed(
                    title=f"{nation}'s national animal is the: {text.title()}", color=color
                )
            ]
        case "animaltrait":
        ...
        case "demonym2plural":
            return [
                discord.Embed(
                    title=f"A group of people from {nation} are called {text}", color=color
                )
            ]
        case "dispatches":
        ...
        case "endorsements":
            if text:
                ...
                return [
                    discord.Embed(title=f"{nation} has been endorsed by zero nations!", color=color)
                ]
        case "factbooks":
            return [
                discord.Embed(
                    title=f"{nation} has a total of {text} factbooks written about them.",
                    color=color,
                )
            ]
        case "factbooklist":
        ...
        case "firstlogin":
            return [
                discord.Embed(
                    title=f"The nation of {nation} was first logged in on {text}.", color=color
                )
            ]
        case "flag":
        ...
        case "foundedtime":
            return [
                discord.Embed(title=f"The nation of {nation} was founded at {text}.", color=color)
            ]
        case "freedom":
        ...
        case "lastactivity":
            return [
                discord.Embed(title=f"{nation} had their most recent activity {text}.", color=color)
            ]
        case "lastlogin":
        ...
        case "population":
            if len(text) < 4:
                return [
                    discord.Embed(title=f"{nation} has a population of {text} million", color=color)
                ]
            else:
                return [
                    discord.Embed(
        ...
        case "region":
            return [
                discord.Embed(title=f"{nation} can be found in the {text} region.", color=color)
            ]
        case "religion":
            return [
                discord.Embed(title=f"{text} is the official religion of {nation}.", color=color)
            ]
        case "richest":
            return [
                discord.Embed(
        ...
        case "scvote":
            if text:
                ...
                return [
                    discord.Embed(
                        title=f"{nation} is not a member of the Security Council.", color=color
                    )
                ]
        case "sectors":
            pass
        case "sensibilities":
            return [
                discord.Embed(title=f"The people of {nation} are known to be {text}.", color=color)
            ]
        case "tax":
            return [
                discord.Embed(title=f"The average tax rate in {nation} is {text}%.", color=color)
            ]
        case "tgcanrecruit":
            if text == "1":
                return [
                    discord.Embed(title=f"{nation} can receive recruitment telegrams.", color=color)
                ]
            else:
                return [
                    discord.Embed(
                        title=f"{nation} can not receive recruitment telegrams.", color=color
                    )
                ]
        case "tgcancampaign":
            if text == "1":
                return [
                    discord.Embed(title=f"{nation} can receive campaign telegrams.", color=color)
                ]
            else:
                return [
                    discord.Embed(
                        title=f"{nation} can not receive campaign telegrams.", color=color
                    )
                ]
        case "type":
            return [discord.Embed(title=f"{nation} is a {text}!", color=color)]
        ...
        case "wabadges":
            if text:
                ...
                return [
                    discord.Embed(title=f"{nation}'s has no from the world assembly.", color=color)
                ]
        case "wcensus":
            return [
                discord.Embed(
                    title=f"{nation}'s mining industry ranks {text} in the world.", color=color
                )
            ]
        case "zombie":
            return [discord.Embed(title="ERROR", description=data, color=color)]
